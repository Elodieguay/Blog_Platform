    ...
    return ( 
        ...
        <Container>
            ...
            {content.map((items) => (
                 <div key={items.id} >
                    <Link 
                    href={{pathname:'/blog', query: {id:items.id}}}><h3 className='  uppercase pb-3 decoration-gray-900 font-semibold text-2xl'>{items.title}</h3>
                    </Link> 
                    <img src={items.imageUrl}/>
                    <p className='pt-2'>{items.description.substring(0, 150)}</p>
